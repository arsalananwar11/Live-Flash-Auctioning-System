                ...
                <body style="font-family: Arial, sans-serif; line-height: 1.6; background-color: #f4f4f4; padding: 20px;">
                    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                        ...
                        <div style="text-align: center; margin-top: 20px;">
                            <a href="https://flash-bids.com/auctions/{auction_details.get("auction_id")}" style="background-color: #007bff; color: white; text-decoration: none; padding: 10px 20px; border-radius: 5px; display: inline-block;">View Auction</a>
                        </div>
