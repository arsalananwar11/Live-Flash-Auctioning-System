...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Validate fields
        if not auction_item and not auction_desc and not base_price and not start_time and not end_time and not images_base64:
            return {
                "statusCode": 400,
        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute(insert_query, {
                ...
                "product_images": json.dumps(product_image_urls),  # Store URLs as JSON
            })
            connection.commit()
