...
function renderAuctionData(auctions) {
  ...
  $.each(auctions, function (_, auction) {
    ...
    const imageUrl =
      auction.images && auction.images.length > 0 && auction.images[0].url
    ...
    auctionRow.append(`
          ...
          <div class="auction-card">
              ...
              <header class="card-header">
                  ...
                  <h2 class="header-title">${escapeHtml(
              ...
              <div class="card-details">
                  ...
                  <p class="card-subtitle">Start Time: ${escapeHtml(
                    convertUTCToLocal(auction.start_time)
                  )}</p>
                  <p class="card-subtitle">End Time: ${escapeHtml(
                    convertUTCToLocal(auction.end_time)
                  )}</p>
                  </div>
                  ...
                  <button class="primary-action join-button" data-auction-id="${
                    auction.auction_id
                  }">
